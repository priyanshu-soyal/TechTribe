...
function YourBlog() {
    ...
    const getOwnBlog = async () => {
        try {
            const res = await axios.get(`https://the-techtribe.vercel.app/api/v1/blog/get-own-blogs`, { withCredentials: true });
            if (res.data.success) {
    ...
    const deleteBlog = async (id) => {
        try {
            const res = await axios.delete(`https://the-techtribe.vercel.app/api/v1/blog/delete/${id}`, { withCredentials: true })
            if (res.data.success) {
